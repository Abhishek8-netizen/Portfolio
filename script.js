...
profileLinks = document.querySelectorAll(".profileLink");
eduContent = document.querySelectorAll(".edu_content");
const introPara = document.getElementById("intro_para");
projHint = document.getElementById("project_hint");
projLinks = document.querySelectorAll(".proj_link")
langNames = document.querySelectorAll(".lang_name");
